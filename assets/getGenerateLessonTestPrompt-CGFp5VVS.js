function m(n){const{currentLesson:e,userRequest:a,language:r,tone:l,coachName:g,task:o,topic:t}=n,p=r==="Vietnamese"?"Vietnamese":"English",c=(e==null?void 0:e.type)==="intensity"||(e==null?void 0:e.type)==="comparison"||(e==null?void 0:e.type)==="mistake"||(t==null?void 0:t.toLowerCase().includes("intensity"))||(t==null?void 0:t.toLowerCase().includes("comparison"))||(t==null?void 0:t.toLowerCase().includes("mistake"));let i="",s="",u="",d="";o==="create_reading"?i=c?`Create a structured study guide for a ${n.targetAudience} comparing nuanced vocabulary related to: "${t}".`:`Create an immersive, high-impact lesson for a ${n.targetAudience} on: "${t}".`:o==="convert_to_listening"?(i="TRANSFORM the provided Reading Lesson into a high-quality NATURAL AUDIO SCRIPT.",u=`SOURCE: ${e==null?void 0:e.title}
