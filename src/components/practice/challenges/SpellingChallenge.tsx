...
export const SpellingChallenge: React.FC<Props> = ({ 
    word, userAnswer, onAnswer, isFinishing, result, showHint, containerRef, toggleListening, listeningId 
}) => {
