                ...
                <div className="shrink-0 pt-6 pb-2 mt-auto">
                    {isNewWord ? (
                        ...
                        <div className="max-w-xl mx-auto grid grid-cols-4 items-stretch gap-3">
                            ...
                            <button onClick={() => setIsAIQuizOpen(true)} className="py-5 bg-indigo-600 text-white rounded-2xl flex flex-col items-center justify-center space-y-1.5 transition-all hover:bg-indigo-700 shadow-md shadow-indigo-200"><Zap size={20} fill="currentColor" /><span className="text-[9px] font-black uppercase">AI Review</span></button>
                        </div>
                    )}
                </div>
                </div>
