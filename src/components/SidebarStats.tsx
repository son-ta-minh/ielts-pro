...
const SidebarStats: React.FC<Props> = ({ activeWords, dueReview, apiRequestCount }) => {
  const stats = [
    { label: 'Active', value: activeWords, icon: Library, color: 'text-blue-500' },
    { label: 'Due', value: dueReview, icon: RotateCw, color: 'text-orange-500' },
    { label: 'API', value: apiRequestCount, icon: BrainCircuit, color: 'text-purple-500' },
  ];
