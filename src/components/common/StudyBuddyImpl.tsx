            ...
            {isOpen && menuPos && (
                ...
                >
                    <StudyBuddyCommandBox
                        ...
                        onBriefExplain={(selectedText) => handleBackgroundChatRequest(`No intro and outro, concise and to the point, go straight to briefly explain for the vocabulary "${selectedText || ''}"`)}
