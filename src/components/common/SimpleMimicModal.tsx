...
import { X, Volume2, Mic, Waves, ListPlus, Play } from 'lucide-react';
    ...
    return (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-200">
            <div className="bg-white w-full max-w-md rounded-[2.5rem] shadow-2xl border border-neutral-200 p-8 flex flex-col items-center gap-6 relative">
                ...
                <div className="w-full p-6 bg-neutral-50 rounded-[2rem] border border-neutral-200 flex flex-wrap justify-center gap-x-2 gap-y-1 min-h-[100px] items-center overflow-y-auto custom-scrollbar max-h-[30vh]">
                ...
                <div className="flex items-center gap-6 pt-2">
                    ...
                    >
                        {isRecording ? (
                            /* Only show countdown text when remaining silence time is under 1s (meaning user has been silent for 2s) */
                            timeLeft <= 1000 ? (
