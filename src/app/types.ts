export type AppView = 'AUTH' | 'DASHBOARD' | 'BROWSE' | 'REVIEW' | 'SETTINGS' | 'DISCOVER' | 'UNIT_LIBRARY' | 'WRITING' | 'SPEAKING' | 'LESSON' | 'MIMIC' | 'IRREGULAR_VERBS' | 'NATIVE_SPEAK' | 'WORDBOOK' | 'PLANNING' | 'EXPERIMENT' | 'COURSE' | 'SEARCH';
...
export type DiscoverGame = 'MENU' | 'ADVENTURE' | 'IPA_SORTER' | 'SENTENCE_SCRAMBLE' | 'PREPOSITION_POWER' | 'PARAPHRASE_CONTEXT' | 'WORD_SCATTER' | 'DICTATION' | 'NATURAL_EXPRESSION' | 'INTENSITY_SCALE' | 'COMPARISON_LAB' | 'MISTAKE_RECOGNITION' | 'REGISTER_PICK';
